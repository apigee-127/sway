...
* [sway](#module_sway)
    ...
    * [.DocumentValidationFunction](#module_sway.DocumentValidationFunction) ⇒ <code>module:sway~ValidationResults</code>
    * [.Operation](#module_sway.Operation)
        ...
        * [.getParameter(name, [location])](#module_sway.Operation+getParameter) ⇒ <code>module:sway~Parameter</code>
        * [.getParameters()](#module_sway.Operation+getParameters) ⇒ <code>Array.&lt;module:sway~Parameter&gt;</code>
        * [.getResponse([statusCode])](#module_sway.Operation+getResponse) ⇒ <code>module:sway~Response</code>
        * [.getResponses()](#module_sway.Operation+getResponses) ⇒ <code>Array.&lt;module:sway~Response&gt;</code>
        * [.getSecurity()](#module_sway.Operation+getSecurity) ⇒ <code>Array.&lt;object&gt;</code>
        * [.validateRequest(req, [options])](#module_sway.Operation+validateRequest) ⇒ <code>module:sway~ValidationResults</code>
        * [.validateResponse(res, [options])](#module_sway.Operation+validateResponse) ⇒ <code>module:sway~ValidationResults</code>
    * [.Parameter](#module_sway.Parameter)
        ...
        * [.getValue(req)](#module_sway.Parameter+getValue) ⇒ <code>module:sway~ParameterValue</code>
    ...
    * [.Path](#module_sway.Path)
        ...
        * [.getOperation(idOrMethod)](#module_sway.Path+getOperation) ⇒ <code>Array.&lt;module:sway~Operation&gt;</code>
        * [.getOperations()](#module_sway.Path+getOperations) ⇒ <code>Array.&lt;module:sway~Operation&gt;</code>
        * [.getOperationsByTag(tag)](#module_sway.Path+getOperationsByTag) ⇒ <code>Array.&lt;module:sway~Operation&gt;</code>
        * [.getParameters()](#module_sway.Path+getParameters) ⇒ <code>Array.&lt;module:sway~Parameter&gt;</code>
    * [.RequestValidationFunction](#module_sway.RequestValidationFunction) ⇒ <code>module:sway~ValidationResults</code>
    ...
    * [.Response](#module_sway.Response)
        ...
        * [.validateResponse(res, [options])](#module_sway.Response+validateResponse) ⇒ <code>module:sway~ValidationResults</code>
    * [.ResponseValidationFunction](#module_sway.ResponseValidationFunction) ⇒ <code>module:sway~ValidationResults</code>
    ...
    * [.SwaggerApi](#module_sway.SwaggerApi)
        ...
        * [.getOperation(idOrPathOrReq, [method])](#module_sway.SwaggerApi+getOperation) ⇒ <code>module:sway~Operation</code>
        * [.getOperations([path])](#module_sway.SwaggerApi+getOperations) ⇒ <code>Array.&lt;module:sway~Operation&gt;</code>
        * [.getOperationsByTag([tag])](#module_sway.SwaggerApi+getOperationsByTag) ⇒ <code>Array.&lt;module:sway~Operation&gt;</code>
        * [.getPath(pathOrReq)](#module_sway.SwaggerApi+getPath) ⇒ <code>module:sway~Path</code>
        * [.getPaths()](#module_sway.SwaggerApi+getPaths) ⇒ <code>Array.&lt;module:sway~Path&gt;</code>
        ...
        * [.validate()](#module_sway.SwaggerApi+validate) ⇒ <code>module:sway~ValidationResults</code>
    ...
    * [.create(options)](#module_sway.create) ⇒ <code>Promise.&lt;module:sway~SwaggerApi&gt;</code>
...
| customValidators | <code>Array.&lt;module:sway~DocumentValidationFunction&gt;</code> | The custom validators |

<a name="module_sway.DocumentValidationFunction"></a>

### sway.DocumentValidationFunction ⇒ <code>module:sway~ValidationResults</code>
Function used for custom validation of Swagger documents

**Kind**: static typedef of <code>[sway](#module_sway)</code>  
**Returns**: <code>module:sway~ValidationResults</code> - The validation results  

| Param | Type | Description |
| --- | --- | --- |
| api | <code>module:sway~SwaggerApi</code> | The Swagger API object |
...
| pathObject | <code>module:sway~Path</code> | The `Path` object |
| pathToDefinition | <code>Array.&lt;string&gt;</code> | The path segments to the operation definition |
| parameterObjects | <code>Array.&lt;module:sway~Parameter&gt;</code> | The `Parameter` objects |
...
#### operation.getParameter(name, [location]) ⇒ <code>module:sway~Parameter</code>
...
**Returns**: <code>module:sway~Parameter</code> - The `Parameter` matching the location and name combination or `undefined` if there
is no match  
...
#### operation.getParameters() ⇒ <code>Array.&lt;module:sway~Parameter&gt;</code>
Returns all parameters for the operation.

**Kind**: instance method of <code>[Operation](#module_sway.Operation)</code>  
**Returns**: <code>Array.&lt;module:sway~Parameter&gt;</code> - All `Parameter` objects for the operation  
<a name="module_sway.Operation+getResponse"></a>

#### operation.getResponse([statusCode]) ⇒ <code>module:sway~Response</code>
Returns the response for the requested status code or the default response *(if available)* if none is provided.

**Kind**: instance method of <code>[Operation](#module_sway.Operation)</code>  
**Returns**: <code>module:sway~Response</code> - The `Response` or `undefined` if one cannot be found  
...
#### operation.getResponses() ⇒ <code>Array.&lt;module:sway~Response&gt;</code>
Returns all responses for the operation.

**Kind**: instance method of <code>[Operation](#module_sway.Operation)</code>  
**Returns**: <code>Array.&lt;module:sway~Response&gt;</code> - All `Response` objects for the operation  
...
#### operation.validateRequest(req, [options]) ⇒ <code>module:sway~ValidationResults</code>
...
| [options] | <code>module:sway~RequestValidationOptions</code> | The validation options |

<a name="module_sway.Operation+validateResponse"></a>

#### operation.validateResponse(res, [options]) ⇒ <code>module:sway~ValidationResults</code>
...
| Param | Type | Description |
| --- | --- | --- |
| res | <code>module:sway~ServerResponseWrapper</code> | The response or response like object |
| [options] | <code>module:sway~ResponseValidationOptions</code> | The validation options |
...
| operationObject | <code>module:sway~Operation</code> | The `Operation` object the parameter belongs to *(Can be `undefined` for path-level parameters)* |
| pathObject | <code>module:sway~Path</code> | The `Path` object the parameter belongs to |
...
| Param | Type | Description |
| --- | --- | --- |
| opOrPathObject | <code>module:sway~Operation</code> &#124; <code>module:sway~Path</code> | The `Operation` or `Path` object |
| definition | <code>object</code> | The parameter definition *(The raw parameter definition __after__ remote references were resolved)* |
| definitionFullyResolved | <code>object</code> | The parameter definition with all of its resolvable references resolved |
| pathToDefinition | <code>Array.&lt;string&gt;</code> | The path segments to the parameter definition |
...
#### parameter.getValue(req) ⇒ <code>module:sway~ParameterValue</code>
...
**Kind**: instance method of <code>[Parameter](#module_sway.Parameter)</code>  
**Returns**: <code>module:sway~ParameterValue</code> - The parameter value object  
**Throws**:
...
| parameterObject | <code>module:sway~Parameter</code> | The `Parameter` object |
...
| Name | Type | Description |
| --- | --- | --- |
| api | <code>module:sway~SwaggerApi</code> | The `SwaggerApi` object |
...
| operationObjects | <code>Array.&lt;module:sway~Operation&gt;</code> | The `Operation` objects |
| parameterObjects | <code>Array.&lt;module:sway~Parameter&gt;</code> | The path-level `Parameter` objects |
...
#### path.getOperation(idOrMethod) ⇒ <code>Array.&lt;module:sway~Operation&gt;</code>
Return the operation for this path and operation id or method.

**Kind**: instance method of <code>[Path](#module_sway.Path)</code>  
**Returns**: <code>Array.&lt;module:sway~Operation&gt;</code> - The `Operation` objects for this path and method or `undefined` if there is no
...
#### path.getOperations() ⇒ <code>Array.&lt;module:sway~Operation&gt;</code>
Return the operations for this path.

**Kind**: instance method of <code>[Path](#module_sway.Path)</code>  
**Returns**: <code>Array.&lt;module:sway~Operation&gt;</code> - The `Operation` objects for this path  
<a name="module_sway.Path+getOperationsByTag"></a>

#### path.getOperationsByTag(tag) ⇒ <code>Array.&lt;module:sway~Operation&gt;</code>
Return the operations for this path and tag.

**Kind**: instance method of <code>[Path](#module_sway.Path)</code>  
**Returns**: <code>Array.&lt;module:sway~Operation&gt;</code> - The `Operation` objects for this path and tag  
...
#### path.getParameters() ⇒ <code>Array.&lt;module:sway~Parameter&gt;</code>
Return the parameters for this path.

**Kind**: instance method of <code>[Path](#module_sway.Path)</code>  
**Returns**: <code>Array.&lt;module:sway~Parameter&gt;</code> - The `Parameter` objects for this path  
<a name="module_sway.RequestValidationFunction"></a>

### sway.RequestValidationFunction ⇒ <code>module:sway~ValidationResults</code>
...
| --- | --- | --- |
| res | <code>module:sway~ServerResponseWrapper</code> | The response or response like object |
| def | <code>module:sway~Response</code> | The `Response` definition _(useful primarily when calling `Operation#validateResponse` as `Response#validateResponse` the caller should have access to the `Response` object already.)_ |
...
| customValidators | <code>module:sway~RequestValidationFunction</code> |  | The custom validators |
...
| operationObject | <code>module:sway~Operation</code> | The Operation object |
| pathToDefinition | <code>Array.&lt;string&gt;</code> | The path segments to the path definition |
...
#### response.validateResponse(res, [options]) ⇒ <code>module:sway~ValidationResults</code>
Validates the response.
...
### sway.ResponseValidationFunction ⇒ <code>module:sway~ValidationResults</code>
...
| --- | --- | --- |
| req | <code>object</code> | The http client request *(or equivalent)* |
| op | <code>module:sway~Operation</code> | The `Operation` object for the request |
...
| customFormats | <code>object</code> | The key/value pair of custom formats *(The keys are the format name and the values are async functions.  See [ZSchema Custom Formats](https://github.com/zaggino/z-schema#register-a-custom-format))* |
| customFormatGenerators | <code>object</code> | The key/value pair of custom format generators *(The keys are the format name and the values are functions.  See [json-schema-mocker Custom Format](https://github.com/json-schema-faker/json-schema-faker#custom-formats))* |
| customValidators | <code>Array.&lt;module:sway~DocumentValidationFunction&gt;</code> | The array of custom validators |
...
| pathObjects | <code>Array.&lt;module:sway~Path&gt;</code> | The unique `Path` objects |
...
#### swaggerApi.getOperation(idOrPathOrReq, [method]) ⇒ <code>module:sway~Operation</code>
...
**Returns**: <code>module:sway~Operation</code> - The `Operation` for the provided operation id, or path and method or `undefined` if
...
#### swaggerApi.getOperations([path]) ⇒ <code>Array.&lt;module:sway~Operation&gt;</code>
Returns all operations for the provided path or all operations in the API.

**Kind**: instance method of <code>[SwaggerApi](#module_sway.SwaggerApi)</code>  
**Returns**: <code>Array.&lt;module:sway~Operation&gt;</code> - All `Operation` objects for the provided path or all API operations  
...
#### swaggerApi.getOperationsByTag([tag]) ⇒ <code>Array.&lt;module:sway~Operation&gt;</code>
Returns all operations for the provided tag.

**Kind**: instance method of <code>[SwaggerApi](#module_sway.SwaggerApi)</code>  
**Returns**: <code>Array.&lt;module:sway~Operation&gt;</code> - All `Operation` objects for the provided tag  
...
#### swaggerApi.getPath(pathOrReq) ⇒ <code>module:sway~Path</code>
...
**Kind**: instance method of <code>[SwaggerApi](#module_sway.SwaggerApi)</code>  
**Returns**: <code>module:sway~Path</code> - The corresponding `Path` object for the requested path or request  
...
#### swaggerApi.getPaths() ⇒ <code>Array.&lt;module:sway~Path&gt;</code>
Returns all path objects for the Swagger API.

**Kind**: instance method of <code>[SwaggerApi](#module_sway.SwaggerApi)</code>  
**Returns**: <code>Array.&lt;module:sway~Path&gt;</code> - The `Path` objects  
...
| Param | Type | Description |
| --- | --- | --- |
| validator | <code>module:sway~DocumentValidationFunction</code> | The validator |
...
#### swaggerApi.validate() ⇒ <code>module:sway~ValidationResults</code>
...
| errors | <code>Array.&lt;module:sway~ValidationEntry&gt;</code> | The nested error(s) encountered during validation |
...
| Name | Type | Description |
| --- | --- | --- |
| errors | <code>Array.&lt;module:sway~ValidationEntry&gt;</code> | The validation errors |
| warnings | <code>Array.&lt;module:sway~ValidationEntry&gt;</code> | The validation warnings |

<a name="module_sway.create"></a>

### sway.create(options) ⇒ <code>Promise.&lt;module:sway~SwaggerApi&gt;</code>
Creates a SwaggerApi object from its Swagger definition(s).

**Kind**: static method of <code>[sway](#module_sway)</code>  
**Returns**: <code>Promise.&lt;module:sway~SwaggerApi&gt;</code> - The promise  

| Param | Type | Description |
| --- | --- | --- |
| options | <code>module:sway~CreateOptions</code> | The options for loading the definition(s) |
